    ...
    <div class="G_frame">
        <div class="G_main">
            <div class="G_head">
                ...
                <div class="ad"><a href="/union/free/index"><img src="<?= $source; ?>images/pic01.png" class="pic"></a></div>  	
				<?= $this->load->view('/union/header_welcome'); ?>
            </div>

            <div class="G_modwrap">
                <div class="G_tipbar S_line1">您已成功连接到互联网，当前服务类型为：<?= $service['title']; ?>， <a href="<?= $base; ?>union/free/index" class="G_tcol_red G_fb">升级高速上网</a>
                </div>
            </div>
            ...
            <div class="G_modwrap">
                <div class="G_search line_metro_blue clearfix">
                    <form target="_blank" action="http://www.baidu.com/baidu">
                        ...
                        <input type="text" name="word" class="ipt_text" placeholder="请输入关键词">
                        <input  type="submit" class="search_btn metro_blue" value="搜索">
                    </form>
                </div>
            </div>
            <div class="G_modwrap">
                <div class="G_navbox S_line1">
                    <div class="tips">
                        <p class="text"><a href="#">立时世通-AiWiFi无线系统欢迎您，更多优惠和惊喜请点击我，有本店折扣哟</a>
                        </p>
                    </div>
                    ...
                    <div class="content">
                        <div class="popdiv">
                            ...
                            <div class="popdiv_content">
                                <form action="<?= $base; ?>union/user/add_link/" method="post" enctype="multipart/form-data">
                                    <p>
