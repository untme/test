                    ...
                    <div class="m_wrap clearfix">
                        <div class="item_con">
                            <a <?php if($mall['bgcolor']){ echo "style='background-color:#{$mall['bgcolor']}'";} ?> href="/union/activity/alist/<?= $mall['pk_mall'];?>/" class="btnbox">
                                <p <?php if($mall['txtbgcolor']){ echo "style='color:#{$mall['txtbgcolor']}'";} ?> class="title" onClick="alert('暂未开放');return false;"><?php if($mall['adtitle']){echo $mall['adtitle']; }else{ echo '最新活动'; }?></p>
                        ...
                        <div class="item_con_2">
                            <a <?php if($mall['bgcolor']){ echo "style='background-color:#{$mall['bgcolor']}'";} ?> href="/union/mall/info/<?= $mall['pk_mall'];?>/" class="btnbox">
                                <p <?php if($mall['txtbgcolor']){ echo "style='color:#{$mall['txtbgcolor']}'";} ?> class="title" onClick="alert('暂未开放');return false;"><?php if($mall['malltitle']){ echo $mall['malltitle']; }else{ ?>商家信息<?php } ?></p>
                            ...
                            <a  <?php if($mall['bgcolor']){ echo "style='background-color:#{$mall['bgcolor']}'";} ?> href="/union/mall/floor/<?= $mall['pk_mall'];?>/" class="btnbox">
                                <p <?php if($mall['txtbgcolor']){ echo "style='color:#{$mall['txtbgcolor']}'";} ?> class="title" onClick="alert('暂未开放');return false;"><?php if($mall['floortip']){ echo $mall['floortip']; }else{ ?>楼层提示<?php } ?></p>
                        ...
                        <div class="item_con_2">
                            ...
                            <a <?php if($mall['bgcolor']){ echo "style='background-color:#{$mall['bgcolor']}'";} ?> href="/union/brand/search/<?= $mall['pk_mall'];?>/0_0_0/0/" class="btnbox">
                                <p <?php if($mall['txtbgcolor']){ echo "style='color:#{$mall['txtbgcolor']}'";} ?> class="title" onClick="alert('暂未开放');return false;"><?php if($mall['brandqy']){ echo $mall['brandqy']; }else{ ?>品牌查询<?php } ?></p>
