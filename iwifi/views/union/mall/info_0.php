...
<head>
    ...
    <title><?php if($mall['dname']){ echo $mall['dname']; }else{ echo '商家信息'; } ?></title>
            ...
            <div class="G_modwrap">
                <div class="G_tabtext">
                    <div class="tabs clearfix">
                        ...
                        <a href="/union/mall/info/<?= $pk_mall;?>/0" class="tab current"><?php if($mall['dname']){ echo $mall['dname']; }else{ echo '商家信息'; } ?></a>
                        <?php } ?>
                        <?php if($mall['citybus']){ ?>
