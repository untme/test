...
<head>
    ...
    <title><?php if($mall['pkname']){ echo $mall['pkname']; }else{ echo '地下车库'; } ?></title>
            ...
            <div class="G_modwrap">
                <div class="G_tabtext">
                    <div class="tabs clearfix">
                        ...
                        <?php } ?>
                        <?php if($mall['freebus']){ ?>
                        <a href="/union/mall/info/<?= $pk_mall;?>/2" class="tab"><?php if($mall['fbname']){ echo $mall['fbname']; }else{ echo '免费班车'; } ?></a>
                        <?php } ?>
                        <?php if($mall['park']){ ?>
                        <a href="/union/mall/info/<?= $pk_mall;?>/3" class="tab current"><?php if($mall['pkname']){ echo $mall['pkname']; }else{ echo '地下车库'; } ?></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
