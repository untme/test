...
<head>
    ...
    <title><?php if($mall['cbname']){ echo $mall['cbname']; }else{ echo '公交线路'; } ?></title>
            ...
            <div class="G_modwrap">
                <div class="G_tabtext">
                    <div class="tabs clearfix">
                        ...
                        <?php } ?>
                        <?php if($mall['citybus']){ ?>
                        <a href="/union/mall/info/<?= $pk_mall;?>/1" class="tab current"><?php if($mall['cbname']){ echo $mall['cbname']; }else{ echo '公交线路'; } ?></a>
                        <?php } ?>
                        <?php if($mall['freebus']){ ?>
