                ...
                <table>
					...
					<thead>
						<tr>
						   ...
						   <th style="width: 20%;">品牌名称</th>
						    <th style="width: 5%;text-align:center;">楼层</th>
						     <th style="width: 5%;text-align:center;">类型</th>
						   <th style="width: 20%;text-align:center;">归属商家</th>
						   <th style="width: 10%;text-align:center;">品牌状态</th>
						...
						<tr>
							<td colspan="6">
								<div class="bulk-actions align-left">
									<a class="button" href="<?= $base; ?>control_panel/brand/new_brand_show/">添加品牌信息</a>
								</div>
					...
					<tbody>
                        ...
                        <tr>
							...
							<td class="txt_center">1F</td>
							<td class="txt_center">女装</td>
							<td class="txt_center">华堂商场</td>
							<!--状态   正常，关闭-->
							<td class="txt_center"><?php echo $rows['status']?"<span class='txtCmmon'>正常展示</span>":"<span class='txtAlarm'>关闭展示</span>"; ?></td>
