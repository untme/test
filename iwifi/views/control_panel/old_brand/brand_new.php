		...
		<div class="content-box-content">
			<div class="tab-content default-tab" id="tablefield">
				...
				<p>
					<span>所属楼层 : </span>
					<select id="type" name="type">
						<option value="2000000">1F</option>
			        	<option selected="" value="1000000">-5F</option>
			        	<option value="2000000">-4F</option>
			        	<option value="2000000">-3F</option>
			        	<option value="2000000">-2F</option>
			        	<option value="2000000">-1F</option>
			        </select>		        
                    <br /><small>标明所属商家</small>
				</p>
				...
				<p>
					...
					<textarea class="text-input medium-input" name="store_descript" style="height:200px; width:800px;"></textarea>
				</p>  
				<p>
					<span>品牌详情 : </span>
