...
<div id="frame_content">
    	...
    	<div class="pcont-1"><div class="pcont-2"><div class="pcont-3">
    		<div id="adminbarleft">当前所在的位置 : 广告管理 - 添加新验证图片</div>
		...
		<div class="content-box-header">
  		...
  		<div class="content-box-content">
			<div class="tab-content default-tab" id="tablefield">
                ...
                <p>广告名称: <input name="ad_name" type="text" value="" class="text-input small-input"></p>
                <p>上传图片: <input id="file" type="file" name="adImg" class="text-input small-input" onchange="ImagePreview('file','preview');"></p>
                <p>预览:<br /><div id="localImag" style="width:300px; height:150px;"><img id="preview" src="#" width="300" height="150" border="1"/></div></p>
                <p>验证码: <input name="ad_code" type="text" value="" class="text-input small-input"></p>
                <p>提示文字: <input name="ad_code_word" type="text" value="" class="text-input small-input"></p>
           	  </form>
              <hr />
              <div class="clear"></div>
			<a class="button" href="javascript:$('#form1').submit();">添加</a>
