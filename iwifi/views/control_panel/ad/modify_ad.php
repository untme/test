	...
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-content">
			<div class="tab-content default-tab" id="tablefield">
				...
				<form id="checkfrom" method="post" target="_self" action="<?= $base; ?>control_panel/advertisement/modify_ad/<?= $ad_page['page_type_id']; ?>/<?= $lang['lang_type_id']; ?>/<?= $adinfo['ad_id']; ?>" enctype="multipart/form-data">
				...
				<?php if (!empty($adinfo['ad_img'])): ?>
				<p>
					<span>广告图片预览 : </span>
					<img src="<?= $base; ?>data/ad/<?= $adinfo['ad_img']; ?>" style="max-width: 880px;" />
				</p>
				<?php endif; ?>
                ...
                <p>
                    ...
                    <br /><small>如果不需要更改广告图片, 请不要填写.</small>
				</p>
				
                <p>
					<span>广告图片验证码 : </span>
					<input class="text-input small-input" type="text" id="ad_code" name="ad_code" value="<?= $adinfo['ad_code']; ?>" />
                    <br /><small>输入相对应的该图片中的广告验证码.</small>
				</p>
				
                <p>
					<span>验证码提示文字 : </span>
					<input class="text-input small-input" type="text" id="ad_code_word" name="ad_code_word" value="<?= $adinfo['ad_code_word']; ?>" />
                    <br /><small>输入验证码提示的文字内容.</small>
				</p>

                <p>
					<input class="button submitNewAD" type="button" value="更 改" />
