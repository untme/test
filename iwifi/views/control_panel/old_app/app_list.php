                ...
                <table>
						...
						<tr>
							<td colspan="6">
								<div class="bulk-actions align-left">
									<a class="button" href="<?= $base; ?>control_panel/app/new_app_show/">添加App信息</a>
								</div>
					...
					<tbody>
                        ...
                        <tr>
							...
							<td class="txt_center">游戏应用</td>
							<td class="txt_center">2012-05-15</td>
