	...
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-content">
			<div class="tab-content default-tab" id="tablefield">
				...
				<form id="checkfrom" method="post" target="_self" action="<?= $base; ?>control_panel/navigator/modify_nav/<?= $navinfo['nav_id']; ?>" enctype="multipart/form-data">
                ...
                <p>
					<span>图标预览 : </span>
					<img src="<?= $base; ?>data/navigator/<?= $navinfo['nav_img']; ?>" />
				</p>
				<?php endif; ?>
