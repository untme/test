...
$(document).ready(function(){
    ...
    $(".delNav").click(function(){
    	...
    	if (sureDelNav) {
			...
			$.ajax({
	        	type: "POST",
	        	url: "<?= $base; ?>control_panel/navigator/delete_nav/",
	        	data: {nav_id: nav_id},
                ...
                <table>
						...
						<tr>
							<td colspan="6">
								<div class="bulk-actions align-left">
									<a class="button" href="<?= $base; ?>control_panel/navigator/new_nav/">添加新链接</a>
								</div>
					...
					<tbody>
                        ...
                        <tr>
							...
							<td class="operate">
                                <a href="<?= $base; ?>control_panel/navigator/modify_nav/<?= $rows['nav_id']; ?>" title="修改链接属性">修改</a>    
