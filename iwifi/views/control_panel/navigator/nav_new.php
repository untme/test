...
$(document).ready(function(){
    ...
    $(".backtouserlist").click(function(){
    	...
    	window.location.href="<?= $base; ?>control_panel/navigator/index/";
	...
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-content">
			<div class="tab-content default-tab" id="tablefield">
				...
				<form id="checkfrom" method="post" target="_self" action="<?= $base; ?>control_panel/navigator/new_nav/" enctype="multipart/form-data">
                
                <input type="hidden" name="action" value="action" />
                
                <p>
					<span>链接名称 : </span>
					<input class="text-input small-input" type="text" id="nav_title" name="nav_title" />
                    <br /><small>链接标题名称.</small>
				</p>
				
				<p>
					<span>链接地址 : </span>
					<input class="text-input small-input" type="text" id="nav_link" name="nav_link" />
                    <br /><small>改链接的地址, 包括http://.</small>
				</p>
				
				<p>
					<span>链接排序 : </span>
					<input class="text-input small-input" type="text" id="nav_sort" name="nav_sort" value="9999" />
