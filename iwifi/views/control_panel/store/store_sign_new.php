	...
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-content">
			<div class="tab-content default-tab" id="tablefield">
				...
				<form id="checkform" method="post" target="_self" action="<?= $base; ?>control_panel/store/new_sign/<?= $store_id; ?>" enctype="multipart/form-data">
				...
				<p>
					<span>展示说明文字 : </span>
					<input class="text-input medium-input" type="text" id="sign_word" name="sign_word" />
