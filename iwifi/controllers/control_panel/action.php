...
class Action extends CI_Controller {
	...
	public function index(){
    	...
    	$this->load->view('control_panel/action/action_list', $data);
		
	}
	
	// Add new store page.
	public function new_action_show(){
    	...
    	$this->load->view('control_panel/action/action_new', $data);
